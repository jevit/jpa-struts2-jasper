INSERT INTO ut_utilisateur( version,id , email, firstname, lastname, leavingdatetime, creatingdatetime, login,password,enabled) VALUES (0, nextval('ut_utilisateur_sequence'),'j2@v.com','nom1','prenom1',LOCALTIMESTAMP,LOCALTIMESTAMP,'admin','koala',true);
